...
{
    /**
    * La méthode d'usine réelle. Notez qu'il renvoie le connecteur abstrait.
     * Cela permet aux sous-classes de renvoyer tous les connecteurs concrets sans casser le
     * contrat de superclasse.     */
